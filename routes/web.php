...
Route::post('/assigntask', [App\Http\Controllers\HomeController::class, 'assigntasks'])->name('assi');
Route::get('/edittasks', [App\Http\Controllers\HomeController::class, 'edittask'])->name('assi');
Route::post('/edittasks', [App\Http\Controllers\HomeController::class, 'edittasks'])->name('assi');
