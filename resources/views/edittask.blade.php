    ...
    <div class="col-md-12">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            ...
            <select id="group" name="assigned" type="text" class="form-control cc-name valid" data-val="true" data-val-required="Please enter the name on card" autocomplete="cc-name" aria-required="true" aria-invalid="false" aria-describedby="cc-name-error" required>
        ...
        <option value="{{ $user3->id }}">{{ $user3->name }} {{ $user3->id }}</option>
        @else
