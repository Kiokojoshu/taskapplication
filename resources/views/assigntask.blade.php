...
<div class="row m-t-30">
    <div class="col-md-12">
        <div class="container">
            ...
            <input id="cc-pament" name="taskname"  type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$user2->taskname}}" required disabled>
        </div>
        <div class="form-group">
    <label for="cc-number" class="control-label mb-1">Task status</label>
    <select id="group" name="urgency" class="form-control cc-name valid" required>
        <option value="{{ $user2->statu }}">{{ $user2->statu == 0 ? 'Pending' : ($user2->urgency == 1 ? 'Half done' : 'Complete') }}{{$user2->statu}}</option>
        <option value="0">Pending</option>
        <option value="1">Half done</option>
