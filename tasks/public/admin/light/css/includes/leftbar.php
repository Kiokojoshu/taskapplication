<div class="left-sidebar bg-black-300 box-shadow ">
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    ...
                                    <li class="has-children">
                                      <a href="#"><i class="fa fa-lock"></i> <span>Teachers</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="add-teacher.php"><i class="fa fa-bars"></i> <span>Add teacher</span></a></li>
  ...
  <li class="has-children">
   ...
   <li class="has-children">
                                    ...
                                    <li class="has-children">
                                      <a href="#"><i class="fa fa-lock"></i> <span>Change password</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                            <li><a href="change-password.php"><i class="fa fa-bars"></i> <span>Change admin password</span></a></li>
                                            <li><a href="change-students.php"><i class="fa fa fa-server"></i> <span>Change student password</span></a></li>
                                            <li><a href="change-teachers.php"><i class="fa fa fa-server"></i> <span>Change Teacher password</span></a></li>
...
<li class="has-children">
                                        ...
                                        <li><a href="upload-feesstructure.php"><i class="fa fa fa-server"></i> <span> Upload fees structure</span></a></li>
                                        <li><a href="check-results.php"><i class="fa fa fa-server"></i> <span> Check results</span></a></li>
                                        <li><a href="fees-details.php"><i class="fa fa fa-server"></i> <span> Fees Details</span></a></li>
