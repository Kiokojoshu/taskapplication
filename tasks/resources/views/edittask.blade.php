    ...
    <div class="col-md-12">
        <div class="container">
            ...
            <form action="/edittasks" method="post" >
                ...
                <input type="hidden" name="idara" value="{{request()->id}}">
        ...
        <div class="form-group">
         ...
         <div class="form-group">
            <label for="cc-payment" class="control-label mb-1">Assigned to</label>
            <input id="cc-pament" name="assigned_to" type="text" class="form-control" aria-required="true" aria-invalid="false" value="{{$user2->name}}" required disabled>
        </div>
